        ...
        <form method="POST" action="{{ route('order-aligner.store') }}">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">Observações clínicas atuais do paciente<br/>
                    (limitação periodontal, reabsorções radiculares, perfil aceita retrusão ou protrusão de incisivos,
                    etc.)<br/><br/></div>
                <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="data[tratamento_arcada_superior]">
                            <option value="">SELECIONE</option>
                            <option value="1" {{ old('data')['tratamento_arcada_superior'] == 1 ? 'selected' : '' }}>
                                Tratada com alinhador (má oclusão será corrigida)
                            </option>
                            <option value="2" {{ old('data')['tratamento_arcada_superior'] == 2 ? 'selected' : '' }}>
                                Tratada com ortodontia fixa (má oclusão será corrigida)
                            </option>
                            <option value="3" {{ old('data')['tratamento_arcada_superior'] == 3 ? 'selected' : '' }}>Não
                        ...
                        <div class="radio" style="margin-left: 30px;">
                            <label>
                                <input
                                        ...
                                        {{ (old('data')['nivelamento_incisivos_superiores']['opcao'] ?? 1) != 1 ? 'disabled' : '' }}
                                />Nivelar bordas incisivas dos laterais 0,5 mm mais cervicais às bordas incisivas dos
                                centrais
                            </label>
                        </div>
                        <div class="radio" style="margin-left: 30px;">
                ...
                <div class="form-group">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="data[linha_media][superior]" {{ (old('data')['linha_media']['opcoes'] ?? 1) == 3 ? '' : 'disabled' }}>
                            <option value="1" {{ (old('data')['linha_media']['superior'] ?? 1) == 1 ? 'selected' : '' }}>Não alterar</option>
                            <option value="2" {{ (old('data')['linha_media']['superior'] ?? 1) == 2 ? 'selected' : '' }}>Para direita do paciente</option>
                            <option value="3" {{ (old('data')['linha_media']['superior'] ?? 1) == 3 ? 'selected' : '' }}>Para esquerda do paciente</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label>Inferior:</label>
                        <select class="form-control" name="data[linha_media][inferior]" {{ (old('data')['linha_media']['opcoes'] ?? 1) == 3 ? '' : 'disabled' }}>
                            <option value="1" {{ (old('data')['linha_media']['inferior'] ?? 1) == 1 ? 'selected' : '' }}>Não alterar</option>
                            <option value="2" {{ (old('data')['linha_media']['inferior'] ?? 1) == 2 ? 'selected' : '' }}>Para direita do paciente</option>
                            <option value="3" {{ (old('data')['linha_media']['inferior'] ?? 1) == 3 ? 'selected' : '' }}>Para esquerda do paciente</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <label>
                        11.3 - Para tratamento de casos de fechamento de espaços, realizar sobrecorreção do fechamento
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control" name="data[diastemas][correcao_apinhamento][superior][extracao_transversal]">
                        <option value="">SELECIONE</option>
                        <option value="1" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['extracao_transversal'] ?? '') == 1 ? 'selected' : '' }}>Primeira opção</option>
                        <option value="2" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['extracao_transversal'] ?? '') == 2 ? 'selected' : '' }}>Quando for necessário após a primeira opção</option>
                        <option value="3" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['extracao_transversal'] ?? '') == 3 ? 'selected' : '' }}>Mínimo necessário</option>
                        <option value="4" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['extracao_transversal'] ?? '') == 4 ? 'selected' : '' }}>Não realizar</option>
                    </select>
                    <small class="form-text text-danger">
                    ...
                    <select class="form-control" name="data[diastemas][correcao_apinhamento][superior][vestibularizacao_incisivos]">
                        <option value="">SELECIONE</option>
                        <option value="1" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['vestibularizacao_incisivos'] ?? '') == 1 ? 'selected' : '' }}>Primeira opção</option>
                        <option value="2" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['vestibularizacao_incisivos'] ?? '') == 2 ? 'selected' : '' }}>Quando for necessário após a primeira opção</option>
                        <option value="3" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['vestibularizacao_incisivos'] ?? '') == 3 ? 'selected' : '' }}>Mínimo necessário</option>
                        <option value="4" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['vestibularizacao_incisivos'] ?? '') == 4 ? 'selected' : '' }}>Não realizar</option>
                    </select>
                    <small class="form-text text-danger">
                    ...
                    <select class="form-control" name="data[diastemas][correcao_apinhamento][superior][dip_anterior]">
                        <option value="">SELECIONE</option>
                        <option value="1" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['dip_anterior'] ?? '') == 1 ? 'selected' : '' }}>Primeira opção</option>
                        <option value="2" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['dip_anterior'] ?? '') == 2 ? 'selected' : '' }}>Quando for necessário após a primeira opção</option>
                        <option value="3" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['dip_anterior'] ?? '') == 3 ? 'selected' : '' }}>Mínimo necessário</option>
                        <option value="4" {{ (old('data')['diastemas']['correcao_apinhamento']['superior']['dip_anterior'] ?? '') == 4 ? 'selected' : '' }}>Não realizar</option>
                    </select>
                    <small class="form-text text-danger">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control" name="data[diastemas][correcao_apinhamento][inferior][extracao_transversal]">
                        <option value="">SELECIONE</option>
                        <option value="1" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['extracao_transversal'] ?? '') == 1 ? 'selected' : '' }}>Primeira opção</option>
                        <option value="2" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['extracao_transversal'] ?? '') == 2 ? 'selected' : '' }}>Quando for necessário após a primeira opção</option>
                        <option value="3" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['extracao_transversal'] ?? '') == 3 ? 'selected' : '' }}>Mínimo necessário</option>
                        <option value="4" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['extracao_transversal'] ?? '') == 4 ? 'selected' : '' }}>Não realizar</option>
                    </select>
                    <small class="form-text text-danger">
                    ...
                    <select class="form-control" name="data[diastemas][correcao_apinhamento][inferior][vestibularizacao_incisivos]">
                        <option value="">SELECIONE</option>
                        <option value="1" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['vestibularizacao_incisivos'] ?? '') == 1 ? 'selected' : '' }}>Primeira opção</option>
                        <option value="2" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['vestibularizacao_incisivos'] ?? '') == 2 ? 'selected' : '' }}>Quando for necessário após a primeira opção</option>
                        <option value="3" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['vestibularizacao_incisivos'] ?? '') == 3 ? 'selected' : '' }}>Mínimo necessário</option>
                        <option value="4" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['vestibularizacao_incisivos'] ?? '') == 4 ? 'selected' : '' }}>Não realizar</option>
                    </select>
                    <small class="form-text text-danger">
                    ...
                    <select class="form-control" name="data[diastemas][correcao_apinhamento][inferior][dip_anterior]">
                        <option value="">SELECIONE</option>
                        <option value="1" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['dip_anterior'] ?? '') == 1 ? 'selected' : '' }}>Primeira opção</option>
                        <option value="2" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['dip_anterior'] ?? '') == 2 ? 'selected' : '' }}>Quando for necessário após a primeira opção</option>
                        <option value="3" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['dip_anterior'] ?? '') == 3 ? 'selected' : '' }}>Mínimo necessário</option>
                        <option value="4" {{ (old('data')['diastemas']['correcao_apinhamento']['inferior']['dip_anterior'] ?? '') == 4 ? 'selected' : '' }}>Não realizar</option>
                    </select>
                    <small class="form-text text-danger">
                        {{ $errors->first('data.diastemas.correcao_apinhamento.inferior.dip_anterior') }}
                    </small>
                ...
                <div class="col-md-12">
                    <label>
                        ...
                        contenções (Smart Retainer), para confecção de alinhadores (Smart Aligner) são apenas aceitas
                ...
                <div class="col-md-12">
                    <label>
                        16 - ANEXE AQUI OS ARQUIVOS OBRIGATÓRIOS<br/>- Modelos digitais por meio de escaneamento
                    ...
                    <input type="file" name="file_foto_frontal">
                    <br/><br/>
                    <label>
                        2. Foto frontal sorrindo
                    </label>
                    <input type="file" name="file_foto_frontal_sorrindo">
                    <br/><br/>
                    <label>
                        3. Foto perfil direito
                    </label>
                    <input type="file" name="file_foto_perfil_direito">
                    <br/><br/>
                    <label>
                        4. Foto oclusal superior
                    </label>
                    <input type="file" name="file_foto_oclusal_superior">
                    <br/><br/>
                    <label>
                        5. Foto oclusal inferior
                    </label>
                    <input type="file" name="file_foto_oclusal_inferior">
                    <br/><br/>
                    <label>
                        6. Foto intrabucal frontal
                    </label>
                    <input type="file" name="file_foto_intrabucal_frontal">
                    <br/><br/>
                    <label>
                        7. Foto intrabucal lado direito
                    </label>
                    <input type="file" name="file_foto_intrabucal_lado_direito">
                    <br/><br/>
                    <label>
