        ...
        <div class="panel-body">
            <div class="col-lg-12" style="background-color: #c8e0f0; margin-top: 15px; padding-top: 20px;">
                <div class="col-lg-6">
                    ...
                    <p>Nome do dentista:&nbsp;&nbsp;{{ $order->dentist->name }}</p>
                    <p>Nome do paciente:&nbsp;&nbsp;{{ $order->patient->name }}</p>
                    <p>Valor total do Pedido:&nbsp;&nbsp;R$ {{ number_format($order->total_value, 2, ',', ' ') }}</p>
                    <p>Valor da multa:&nbsp;&nbsp;<b>R$ 300,00</b></p>
                </div>
            </div>
        </div>
    </div>
